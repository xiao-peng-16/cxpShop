...
/*店铺表*/
create table store(
		storeID int references  user(uID),
		storeName char(10) comment '店铺名',
		sProvince char(10) comment '**省',
		sCity char(5) comment '**市',
		sGradeDescribe float(6,5) default 4.82345 comment '如实描述',
...
create table commodity(
		...
		cPrice decimal(10,2) comment '商品价格',
		cSalesVolume int default 0  comment '销量',
		cPopularity  int default 0  comment '人气 (点击量)',
		cStock int default 0 comment '库存'
);
/*购物车 中商品*/
...
create table order_form(
	...
	cID int references  commodity(cID),
	shop_number int comment '数量',
	cPrice decimal(10,2) comment '商品单价',
